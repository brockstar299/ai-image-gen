...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ai-image
```

A live public deployment of this template is available at [https://ai-image.templates.workers.dev](https://ai-image.templates.workers.dev)
